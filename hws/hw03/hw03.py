...
def interleaved_sum(n, odd_term, even_term):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper(i, term1, term2, n):
        if i == n:
            return term1(i)
        else:
            return term1(i) + helper(i+1,term2,term1,n)
    return helper(1,odd_term,even_term,n)
...
def count_coins(total):
    ...
    def helper(rest,n):
        ...
        if n == None:
            return 0
        if n > rest:
            return helper(rest,next_smaller_coin(n))
        return helper(rest - n, n) + helper(rest,next_smaller_coin(n))
